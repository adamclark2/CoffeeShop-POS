...
test: debug
	...
	cat examples/operations.4.txt | dotnet run --project Source/Console-App/ examples/input.4.json > debug/4-4.txt
	cat examples/operations.5.txt | dotnet run --project Source/Console-App/ examples/input.5.json > debug/5-5.txt
	cat examples/operations.6.txt | dotnet run --project Source/Console-App/ examples/input.6.json > debug/6-6.txt
